...
class TryCatchTest {
    ...
    fun testMultipleCatchOrder() {
        ...
        assertEquals(multipleCatchClass.factory.Type().createReference<Any>("java.lang.RuntimeException"),
        ...
        assertEquals(
            "try {} catch (e: java.lang.RuntimeException) {} catch (e: kotlin.Throwable) {} finally {}",
